# Embedded Virtual Machine Demo Platforms

This repository contains hardware platform and platform definitions that are used by the [`blinky`](https://github.com/embvm/blinky) and [`embvm-demo`](https://github.com/embvm/embvm-demo) example applications.
...
The platforms defined in this repository are separated from the applications, the drivers, and the [`embvm-core`](https://github.com/embvm/embvm-core/) project to demonstrate the modular nature of the Embedded VM ecosystem. The same platform repository can be used to support multiple applications.

> Of course, you can always keep your applications, platforms, and drivers together. We want it to be flexible!

**[Back to top](#table-of-contents)**

# Project Status

These platforms are usable, but will continue to evolve as we expand the Embedded VM ecosystem.

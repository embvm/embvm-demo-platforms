...
void NucleoL4RZI_BlinkyPlatform::earlyInitHook_() noexcept
{
...
void NucleoL4RZI_BlinkyPlatform::initOS_() noexcept
{
	// TODO: freertos threaded support
}

void NucleoL4RZI_BlinkyPlatform::initHWPlatform_() noexcept
{
	hw_platform_.init();
}

void NucleoL4RZI_BlinkyPlatform::initProcessor_() noexcept
{
	hw_platform_.initProcessor();
}

void NucleoL4RZI_BlinkyPlatform::init_() noexcept {}

void NucleoL4RZI_BlinkyPlatform::startBlink() noexcept
{
